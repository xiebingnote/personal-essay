...
User=root
Group=root
ExecStart=${nsq_path}/nsq/bin/nsqd -lookupd-tcp-address=$node_ip:4160 -broadcast-address=$node_ip
...
User=root
Group=root
ExecStart=${nsq_path}/nsq/bin/nsqadmin --lookupd-http-address=$node_ip:4161
